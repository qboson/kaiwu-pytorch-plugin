...
#   DATASET=creditcard bash run_public_ad.sh        # creditcard
#   EPOCHS=5 bash run_public_ad.sh                  # 5 epochs (quick test)
#   DATASET=creditcard EPOCHS=10 bash run_public_ad.sh

set -e

# Python venv path
PYTHON=${PYTHON:-/Users/chang137/GitHub/myenv/bin/python}
